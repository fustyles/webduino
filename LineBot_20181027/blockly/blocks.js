  ...
  onchange: function(event) {
    //if (event.type=="change") {
      if (this.getField('value_type').getValue() == 'text') {
        ...
        if (this.getInput('value_parameter2').visible_==true||this.getInput('value_parameter3').visible_==true||this.getInput('value_parameter4').visible_==true) this.unplugBlocks();
        ...
        if (this.getInput('value_parameter3').visible_==true||this.getInput('value_parameter4').visible_==true) this.unplugBlocks();
        this.getInput('value_parameter3').setVisible(false);
        this.getInput('value_parameter4').setVisible(false);
...
Blockly.Blocks['linenotify_type'] = {
  ...
  onchange: function(event) {
    if (this.getField('value_type').getValue() == 'text') {
      ...
      this.getField('p2').setVisible(false);
      this.getField('p3').setVisible(false); 
      if (this.getInput('value_parameter2').visible_==true||this.getInput('value_parameter3').visible_==true) this.unplugBlocks();
      this.getInput('value_parameter2').setVisible(false);
      this.getInput('value_parameter3').setVisible(false);
    } else if (this.getField('value_type').getValue() == "sticker") {
      this.getField('p1').setValue("text");
