...
Blockly.JavaScript['linebot_type'] = function(block) {
  ...
  value_parameter1 = escape(value_parameter1).replace(/\%26/g," ").replace(/\%23/g," ");
  value_parameter2 = escape(value_parameter2).replace(/\%26/g," ").replace(/\%23/g," ");
  value_parameter3 = escape(value_parameter3).replace(/\%26/g," ").replace(/\%23/g," ");
  value_parameter4 = escape(value_parameter4).replace(/\%26/g," ").replace(/\%23/g," ");
