...
+(function (window, document) {
  ...
  function linebot_url_escape(type,parameter1,parameter2,parameter3,parameter4) {
    ...
    parameter1 = escape(parameter1.toString()).replace(/\%5C/g,"fu01fu").replace(/\%26/g,"fu02fu").replace(/\%23/g,"fu03fu").replace(/\+/g,"%2B");
    parameter2 = escape(parameter2.toString()).replace(/\%5C/g,"fu01fu").replace(/\%26/g,"fu02fu").replace(/\%23/g,"fu03fu").replace(/\+/g,"%2B");
    parameter3 = escape(parameter3.toString()).replace(/\%5C/g,"fu01fu").replace(/\%26/g,"fu02fu").replace(/\%23/g,"fu03fu").replace(/\+/g,"%2B");
    parameter4 = escape(parameter4.toString()).replace(/\%5C/g,"fu01fu").replace(/\%26/g,"fu02fu").replace(/\%23/g,"fu03fu").replace(/\+/g,"%2B");
