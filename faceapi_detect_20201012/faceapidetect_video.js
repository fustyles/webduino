...
document.write('<div id="region_faceapidetect" style="z-index:999"><video id="gamevideo_faceapidetect" style="position:absolute;" preload autoplay loop muted></video><img id="gameimg_faceapidetect" style="position:absolute;visibility:hidden;" crossorigin="anonymous"><div id="webcam-container" style="position:absolute;"></div><select id="frame_faceapidetect" style="position:absolute;visibility:hidden;"><option value="1">Y</option><option value="0">N</option></select><div id="result_faceapidetect" style="color:red;position:absolute"></div></div>');
