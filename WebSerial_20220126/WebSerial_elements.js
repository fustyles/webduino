...
document.write('<button id="gamebutton_webserial_open" style="display:none;z-index:999">Close Port</button>');
document.write('<button id="gamebutton_webserial_close" style="z-index:999">Select Port</button>');
