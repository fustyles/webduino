...
document.write('<div id="region_mobilenet" style="z-index:999"><video id="gamevideo_mobilenet" style="position:absolute;visibility:hidden;" preload autoplay loop muted></video><canvas id="gamecanvas_mobilenet"></canvas><img id="gameimg_mobilenet" style="position:absolute;visibility:hidden;" crossorigin="anonymous"><br><select id="mirrorimage_mobilenet" style="position:absolute;visibility:hidden;"><option value="1">Y</option><option value="0">N</option></select><select id="opacity_mobilenet" style="position:absolute;visibility:hidden;"><option value="1">1</option><option value="0.9">0.9</option><option value="0.8">0.8</option><option value="0.7">0.7</option><option value="0.6">0.6</option><option value="0.5">0.5</option><option value="0.4">0.4</option><option value="0.3">0.3</option><option value="0.2">0.2</option><option value="0.1">0.1</option><option value="0">0</option></select><br><div id="gamediv_mobilenet" style="color:red"></div></div>');
