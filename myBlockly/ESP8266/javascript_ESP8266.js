Blockly.JavaScript['esp8266_system'] = function(block) {
  ...
  var code = "esp8266_system('"+dropdown_cmd+"',"+value_str1+","+value_str2+","+value_str3+");\n";
  return code;
};
...
Blockly.JavaScript['esp8266_car'] = function(block) {
  ...
  var code = "esp8266_car("+value_cmd+","+value_str1+","+value_str2+","+value_str3+","+value_str4+","+value_str5+","+value_str6+","+value_str7+",'"+dropdown_str8+"');\n";
  return code;
};
...
Blockly.JavaScript['esp8266_custom'] = function(block) {
  ...
  var code = "esp8266_custom("+value_cmd+","+value_str1+","+value_str2+","+value_str3+","+value_str4+","+value_str5+","+value_str6+","+value_str7+","+value_str8+","+value_str9+");\n";
  return code;
};
