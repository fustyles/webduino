...
Blockly.Blocks['button_set'] = {
  ...
  this.appendDummyInput()  
      ...
      .appendField(new Blockly.FieldDropdown([["left","left"], ["top","top"], ["width","width"], ["height","height"], ["opacity","opacity"], ["backgroundcolor","backgroundcolor"], ["value","value"], ["zindex","zindex"], ["display","display"]]), "property_");
  this.appendValueInput("value_")
      .setAlign(Blockly.ALIGN_RIGHT)
      .setCheck(null);    
  this.setInputsInline(true);
