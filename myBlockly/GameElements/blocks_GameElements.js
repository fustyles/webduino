...
Blockly.Blocks['table_set'] = {
  ...
  this.appendDummyInput()  
      ...
      .appendField(new Blockly.FieldDropdown([["left","left"], ["top","top"], ["borderstyle","borderstyle"], ["borderwidth","borderwidth"], ["bordercolor","bordercolor"], ["cellwidth","cellwidth"], ["cellheight","cellheight"], ["cellcolor","cellcolor"], ["backgroundimage","backgroundimage"], ["backgroundcolor","backgroundcolor"], ["zindex","zindex"], ["display","display"]]), "property_");
...
Blockly.Blocks['return_async_function'] = {
  init: function () {
  this.appendValueInput("name_")
      .setCheck("String")   
      .appendField(Blockly.Msg.RETURN_ASYNC_FUNCTION_SHOW); 
  this.setInputsInline(true);
  this.setOutput(true, null); 
  this.setColour(200);
  }
