...
Blockly.Msg.TABLE_CREATE_SHOW = "新增 表格";
Blockly.Msg.TABLE_SET_SHOW = "設定 表格";
Blockly.Msg.TABLE_TD_WIDTH_SHOW = "儲存格 寬度";
Blockly.Msg.TABLE_TD_HEIGHT_SHOW = "儲存格 高度";
...
Blockly.Msg.TABLE_BGCOLOR_SHOW = "儲存格 顏色";
...
Blockly.Msg.TABLE_TD_CLEAR_SHOW = "清除 儲存格 ";
Blockly.Msg.TABLE_DELETE_SHOW = "表格 刪除";
Blockly.Msg.TABLE_GET_SHOW = "取得 表格";
Blockly.Msg.TABLE_CLEAR_SHOW = "清除 表格";
Blockly.Msg.TABLE_TD_SET_SHOW = "設定 儲存格";
Blockly.Msg.TABLE_BORDER_SET_SHOW = "表格 設定";
Blockly.Msg.TABLE_TD_BORDER_SET_SHOW = "儲存格 設定框線";
...
Blockly.Msg.CANVAS_CREATE_SHOW = "建立 畫布";
...
Blockly.Msg.CANVAS_CLEAR_SHOW = "清除 畫布";
Blockly.Msg.CANVAS_DELETE_SHOW = "刪除 畫布";
Blockly.Msg.IMAGE_CREATE_SHOW = "建立 圖片";
