    ...
    if ((input_trcount>=1)&&(input_tdcount>=1)){
      ...
      for (var i=0;i<input_trcount;i++){
        ...
        for (var j=0;j<input_tdcount;j++){
          ...
          td.setAttribute("ondrop","javascript:event.preventDefault();var obj=document.getElementById(event.dataTransfer.getData('text'));event.target.appendChild(obj);obj.style.left=null;obj.style.top=null;");
