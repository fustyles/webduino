// Author: Chung-Yi Fu (Kaohsiung, Taiwan)   https://www.facebook.com/francefu
  ...
  function elements_collision(element1,input_id1,element2,input_id2,input_position) {
    if ((document.getElementById(element1+input_id1))&&(document.getElementById(element2+input_id2)))
    {
      ...
      var state=0;
      if ((((x2>=x1)&&(x2<=x1_w))&&((y2>=y1)&&(y2<=y1_h)))||(((x2>=x1)&&(x2<=x1_w))&&((y2_h>=y1)&&(y2_h<=y1_h)))||(((x2_w>=x1)&&(x2_w<=x1_w))&&((y2>=y1)&&(y2<=y1_h)))||(((x2_w>=x1)&&(x2_w<=x1_w))&&((y2_h>=y1)&&(y2_h<=y1_h)))||((x1>=x2)&&(x1_w<=x2_w)))
        state=1;
      else if ((((x1>=x2)&&(x1<=x2_w))&&((y1>=y2)&&(y1<=y2_h)))||(((x1>=x2)&&(x1<=x2_w))&&((y1_h>=y2)&&(y1_h<=y2_h)))||(((x1_w>=x2)&&(x1_w<=x2_w))&&((y1>=y2)&&(y1<=y2_h)))||(((x1_w>=x2)&&(x1_w<=x2_w))&&((y1_h>=y2)&&(y1_h<=y2_h)))||((x1>=x2)&&(x1_w<=x2_w)))
        state=1;
      else
        state=0;  
