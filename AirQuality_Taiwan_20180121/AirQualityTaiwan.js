  ...
  function getJSON(target)
  {
    var data = $.ajax({
        ...
        success: function(json)
        {
          ...
          {
            PM_data += "SiteName,";
            PM_data += json["SiteName"];            
            PM_data += ",County,";
            PM_data += json["County"];
            PM_data += ",AQI,";
            PM_data += json["AQI"];
            PM_data += ",Pollutant,";
            PM_data += json["Pollutant"];   
            PM_data += ",Status,";
            PM_data += json["Status"];            
            PM_data += ",SO2 (ppb),";
            PM_data += json["SO2"];            
            ...
            PM_data += json["NO"];            
            PM_data += ",WindSpeed (m/sec),";
            PM_data += json["WindSpeed"];
            PM_data += ",WindDirec (degrees),";
            PM_data += json["WindDirec"];
            PM_data += ",PublishTime,";
            PM_data += json["PublishTime"];
            PM_data += ",PM2.5_AVG (μg/m3),";
            PM_data += json["PM2.5_AVG"];  
            PM_data += ",PM10_AVG (μg/m3),";
            PM_data += json["PM10_AVG"];
            PM_data += ",Latitude,";
            PM_data += json["Latitude"];  
            PM_data += ",Longitude,";
            PM_data += json["Longitude"];
            PM_data += ";";
            console.log(PM_data);
          }
        },
