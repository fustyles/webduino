...
Blockly.JavaScript['json_get_column1'] = function (block) { 
  var VAR = Blockly.JavaScript.valueToCode(block, 'VAR', Blockly.JavaScript.ORDER_NONE);
  var COLUMN = Blockly.JavaScript.valueToCode(block, 'COLUMN', Blockly.JavaScript.ORDER_ATOMIC);
...
Blockly.JavaScript['json_get_length'] = function (block) { 
  var VAR = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('VAR'), Blockly.Variables.NAME_TYPE);
...
Blockly.JavaScript['json_get_column_length'] = function (block) { 
  var VAR = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('VAR'), Blockly.Variables.NAME_TYPE);
  var COLUMN = Blockly.JavaScript.valueToCode(block, 'COLUMN', Blockly.JavaScript.ORDER_ATOMIC);
...
Blockly.JavaScript['json_get_column_index_length'] = function (block) { 
  var VAR = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('VAR'), Blockly.Variables.NAME_TYPE);
  var COLUMN = Blockly.JavaScript.valueToCode(block, 'COLUMN', Blockly.JavaScript.ORDER_ATOMIC);  
  var INDEX = Blockly.JavaScript.valueToCode(block, 'INDEX', Blockly.JavaScript.ORDER_ATOMIC);
...
Blockly.JavaScript['password_onchange_do'] = function (block) {
  var value_id_ = Blockly.JavaScript.valueToCode(block, 'id_', Blockly.JavaScript.ORDER_ATOMIC); 
  if ((value_id_.indexOf("'")==0)&&(value_id_.lastIndexOf("'")==value_id_.length-1))
    value_id_ = value_id_.substring(1,value_id_.length-1);
  var statements_do_ = Blockly.JavaScript.statementToCode(block, 'do_');
  var code = 'async function gamepassword_'+value_id_+'_onchange (event) {\n' + statements_do_ + '};\ndocument.getElementById("gamepassword_'+value_id_+'").addEventListener("change", gamepassword_'+value_id_+'_onchange, true);\n';
  return code;
};
...
Blockly.JavaScript['window_prompt'] = function (block) {
  var inputText = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('inputText'), Blockly.Variables.NAME_TYPE);
