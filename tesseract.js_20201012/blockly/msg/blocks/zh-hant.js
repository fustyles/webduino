...
Blockly.Msg.TESSERACT_RECOGNITION_SHOW = "文字辨識 (tesseract) 執行辨識";
Blockly.Msg.TESSERACT_GET_SHOW = "文字辨識 (tesseract) 取得結果";
Blockly.Msg.TESSERACT_RESULT_SHOW = "結果";
Blockly.Msg.TESSERACT_OPACITY_SHOW = "透明度";
Blockly.Msg.TESSERACT_LANG_SHOW = "語言";
Blockly.Msg.TESSERACT_CLEAR_SHOW = "文字辨識 (tesseract) 清除結果";
