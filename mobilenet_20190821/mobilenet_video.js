document.write('<script src="http://cdn.jsdelivr.net/npm/@tensorflow/tfjs@1.0.1"></script>');
document.write('<script src="http://cdn.jsdelivr.net/npm/@tensorflow-models/mobilenet@1.0.0"></script>');
