Blockly.Blocks['addMyBlocks'] = {
  ...
  this.appendDummyInput()
      .appendField(new Blockly.FieldDropdown([
        ...
        [Blockly.Msg.ADDCUSTOMBLOCKS_YOLOV8N_SHOW,"yolov8n_20260715"],
        ...
        [Blockly.Msg.ADDCUSTOMBLOCKS_TEXTTOSPEECH_SHOW,"TextToSpeech_20220729"],
        [Blockly.Msg.ADDCUSTOMBLOCKS_AUDIORECORD_SHOW,"audioRecord_20250405"],
        [Blockly.Msg.ADDCUSTOMBLOCKS_VIDEORECORD_SHOW,"videoRecord_20250610"]
      ]), "func");
  this.setTooltip('');
  this.setColour(20);
    ...
    if (event.element=="field") {
      if (this.id==event.blockId) {
		  ...
		  */
				  ...
				  Code.customTab.$__remove__('https://fustyles.github.io/webduino/yolov8n_20260715/blockly.json');				
            }
				  ...
				  Code.customTab.$__add__('https://fustyles.github.io/webduino/yolov8n_20260715/blockly.json');
	    }
	    ...
	    else if (this.getFieldValue('func')=='llm_20241219') {
				  this.getInputTargetBlock("url").setFieldValue("https://fustyles.github.io/webduino/llm_20241219/blockly.json", "TEXT");
			  }	  
	    else if (this.getFieldValue('func')=='googlemap_20241226') {
				  this.getInputTargetBlock("url").setFieldValue("https://fustyles.github.io/webduino/googlemap_20241226/blockly.json", "TEXT");
			  }
	    else if (this.getFieldValue('func')=='audioRecord_20250405') {
				  this.getInputTargetBlock("url").setFieldValue("https://fustyles.github.io/webduino/audioRecord_20250405/blockly.json", "TEXT");
			  }
	    ...
	    else if (this.getFieldValue('func')=='yolov8n_20260715') {
				  this.getInputTargetBlock("url").setFieldValue("https://fustyles.github.io/webduino/yolov8n_20260715/blockly.json", "TEXT");
			  }				  
