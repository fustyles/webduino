document.write('<div id="region_hands" style="z-index:999"><img id="gameimage_hands" style="position:absolute;visibility:hidden;" crossorigin="anonymous"><canvas id="gamecanvas_hands" style="position:absolute;display:none"></canvas><canvas id="gamecanvas_canvasElement" style="position:absolute;"></canvas><br><select id="hands" style="position:absolute;visibility:hidden;"><option value="1">Y</option><option value="0">N</option></select><select id="mirrorimage_hands" style="position:absolute;visibility:hidden;"><option value="1">Y</option><option value="0">N</option></select><select id="scorelimit_hands" style="position:absolute;visibility:hidden;"><option value="0">0</option><option value="0.1" selected>0.1</option><option value="0.2">0.2</option><option value="0.3">0.3</option><option value="0.4">0.4</option><option value="0.5" selected>0.5</option><option value="0.6">0.6</option><option value="0.7">0.7</option><option value="0.8">0.8</option><option value="0.9">0.9</option></select><br></div><div id="handsState" style="position:absolute;display:none;">1</div><div id="gamediv_lefthand_hands" style="position:absolute;display:none;"></div><div id="gamediv_hands" style="position:absolute;display:none;"></div>');

window.onload = function () {
	var ShowImage = document.getElementById('gameimage_hands');	
