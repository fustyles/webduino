document.write('<video id="video" width="320" height="240" style="position:absolute;display:none;" preload autoplay loop muted></video><canvas id="gamecanvas_tracking" width="320" height="240"></canvas>');
