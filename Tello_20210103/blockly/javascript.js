...
Blockly.JavaScript['tello_iframe3'] = function (block) {
  ...
  var code = 'tello_command("http://127.0.0.1:8001/"+'+value_ip + '+"/go"+" "+'+ value_x + '+" "+'+ value_y + '+" "+'+ value_z + '+" "+'+ value_speed + '+" "+'+ value_mid + ');\nawait delay(' + value_delaytime + ', true);\n';
  return code;
};
...
Blockly.JavaScript['tello_iframe4'] = function (block) {
  ...
  var code = 'tello_command("http://127.0.0.1:8001/"+'+value_ip + '+"/curve"+" "+'+ value_x1 + '+" "+'+ value_y1 + '+" "+'+ value_z1 + '+" "+'+ value_x2 + '+" "+'+ value_y2 + '+" "+'+ value_z2 + '+" "+'+ value_speed + '+" "+'+ value_mid + ');\nawait delay(' + value_delaytime + ', true);\n';
  return code;
};
...
Blockly.JavaScript['tello_iframe5'] = function (block) {
  ...
  var code = 'tello_command("http://127.0.0.1:8001/"+'+value_ip + '+"/jump"+" "+'+ value_x + '+" "+'+ value_y + '+" "+'+ value_z + '+" "+'+ value_speed + '+" "+'+ value_yaw + '+" "+'+ value_mid1 + '+" "+'+ value_mid2 + ');\nawait delay(' + value_delaytime + ', true);\n';
  return code;
};
...
Blockly.JavaScript['tello_iframe6'] = function (block) {
  ...
  var code = 'tello_command("http://127.0.0.1:8001/"+'+value_ip + '+"/rc"+" "+'+ value_a + '+" "+'+ value_b + '+" "+'+ value_c + '+" "+'+ value_d + ');\nawait delay(' + value_delaytime + ', true);\n';
  return code;
};