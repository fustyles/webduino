...
window.onload = function () {
	...
	function start() {
		...
		if (mirrorimage.value==1) {
			canvasCtx.translate((canvas.width + ShowImage.width) / 2, 0);
			canvasCtx.scale(-1, 1);
