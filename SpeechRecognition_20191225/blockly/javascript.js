...
Blockly.JavaScript['SpeechRecognition_interim_get'] = function (block) {
  var code = 'Recognition_interim_get()';
  return [code, Blockly.JavaScript.ORDER_NONE];
};
