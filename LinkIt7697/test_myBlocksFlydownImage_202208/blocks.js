 ...
 * @Update 8/21/2022 11:00 (Taiwan Standard Time)
 */
...
document.addEventListener('DOMContentLoaded', function() {
	...
	Blockly.myFlydown = function(workspaceOptions) {
	  Blockly.myFlydown.superClass_.constructor.call(this, workspaceOptions);
	};
	Blockly.utils.object.inherits(Blockly.myFlydown, Blockly.VerticalFlyout);
	 ...
	 * @const
	 */
	Blockly.myFlydown.prototype.previousCSSClassName_ = '';
	 ...
	 * @const
	 */
	Blockly.myFlydown.prototype.VERTICAL_SEPARATION_FACTOR = 1;
	 ...
	 */
	Blockly.myFlydown.prototype.createDom = function(cssClassName, backgroundCOLOR) {
	  /*
	  <g>
	 ...
	 */
	Blockly.myFlydown.prototype.setCSSClass = function(newCSSClassName) {
	 ...
	 *     blocks.
	 */
	Blockly.myFlydown.prototype.init = function(workspace) {
	 ...
	 * @private
	 */
	Blockly.myFlydown.prototype.position = function() {
	  return;
	}
	 ...
	 */
	Blockly.myFlydown.prototype.showAt = function(xmlList,x,y) {
	 ...
	 */
	Blockly.myFlydown.prototype.reflow = function() {
	...
	Blockly.myFlydown.prototype.onMouseMove_ = function(e) {
	  // override Blockly's flyout behavior for moving the flyout.
	  return;
	};

	Blockly.myFlydown.prototype.getX = function () {
	  return 0;
	};
	 ...
	 * @private
	 */
	Blockly.myFlydown.prototype.placeNewBlock_ = function(originBlock) {
	...
	Blockly.myFlydown.prototype.shouldHide = true;

	Blockly.myFlydown.prototype.hide = function() {
	  if (this.shouldHide) {
	...
	Blockly.WorkspaceSvg.prototype.myFlydown_ = null;
	Blockly.WorkspaceSvg.prototype.getFlydown = function() {
	  return this.myFlydown_;
	};
	...
	var flydown = new  Blockly.myFlydown(new Blockly.Options({scrollbars:  true }));
	workspace.myFlydown_ = flydown;
