Blockly.Blocks['knnclassifier_esp32cam'] = {
  init: function() {
    this.appendDummyInput()
		.appendField(Blockly.Msg.SERVERMODULE_JAVASCRIPT_SHOW);
    this.appendDummyInput()
      .appendField(Blockly.Msg.ESP32_CAM_KNNCLASSIFIER_SHOW);		
    this.appendStatementInput("javascript_initial")
        .setCheck(null)
		.appendField(Blockly.Msg.ESP32_CAM_KNNCLASSIFIER_INITIAL_SHOW);	
    this.appendStatementInput("javascript_recognition")
        .setCheck(null)
		.appendField(Blockly.Msg.ESP32_CAM_KNNCLASSIFIER_RECOGNITION_SHOW);		
...
Blockly.Blocks['tesseract_esp32cam'] = {
  init: function() {
    this.appendDummyInput()
		.appendField(Blockly.Msg.SERVERMODULE_JAVASCRIPT_SHOW);
    this.appendDummyInput()
      .appendField(Blockly.Msg.ESP32_CAM_TESSERACT_SHOW);		
    this.appendStatementInput("javascript_initial")
        .setCheck(null)
		.appendField(Blockly.Msg.ESP32_CAM_TESSERACT_INITIAL_SHOW);	
    this.appendStatementInput("javascript_recognition")
        .setCheck(null)
		.appendField(Blockly.Msg.ESP32_CAM_TESSERACT_RECOGNITION_SHOW);		
	this.setInputsInline(false);
    this.setOutput(true, null);
...
Blockly.Blocks['posenet_esp32cam'] = {
  init: function() {
    this.appendDummyInput()
		.appendField(Blockly.Msg.SERVERMODULE_JAVASCRIPT_SHOW);
    this.appendDummyInput()
      .appendField(Blockly.Msg.ESP32_CAM_TFJS_POSENET_SHOW);		
    this.appendStatementInput("javascript_initial")
        .setCheck(null)
		.appendField(Blockly.Msg.ESP32_CAM_TFJS_POSENET_INITIAL_SHOW);	
    this.appendStatementInput("javascript_recognition")
        .setCheck(null)
		.appendField(Blockly.Msg.ESP32_CAM_TFJS_POSENET_RECOGNITION_SHOW);		
	this.setInputsInline(false);
    this.setOutput(true, null);
...
Blockly.Blocks['linebot_all'] = {
  init: function() {
	this.appendValueInput("token_")
		.setCheck("String")
		.setAlign(Blockly.ALIGN_RIGHT)
		.appendField(Blockly.Msg.ESP32_LINEBOT_SHOW)
		.appendField(Blockly.Msg.ESP32_LINE_TOKEN_SHOW);  	
	this.appendValueInput("userid_")
		.setCheck("String")
		.setAlign(Blockly.ALIGN_RIGHT)
...
Blockly.Blocks['trackingcolor_esp32cam'] = {
  init: function() {
    this.appendDummyInput()
		.appendField(Blockly.Msg.SERVERMODULE_JAVASCRIPT_SHOW);
    this.appendDummyInput()
      .appendField(Blockly.Msg.ESP32_CAM_TRACKINGCOLOR_SHOW);		
    this.appendStatementInput("javascript_initial")
        .setCheck(null)
		.appendField(Blockly.Msg.ESP32_CAM_TRACKINGCOLOR_INITIAL_SHOW);	
    this.appendStatementInput("javascript_recognition")
        .setCheck(null)
		.appendField(Blockly.Msg.TRACKINGCOLOR_RECOGNITION_SHOW);		
	this.setInputsInline(false);
    this.setOutput(true, null);
    this.setColour(Blockly.Msg["HUE_5"])
	}
