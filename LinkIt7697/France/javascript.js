...
Blockly.Arduino['ps2_stick_direction'] = function(block) {
	...
	+'  }\n'
	+'  float upper = analogMax*3/4;\n'
	+'  float lower = analogMax/4;\n'
	+'  if (X<lower&&Y<lower)\n  return ps2_rotate[0];\n'
	+'  if (X>=lower&&X<upper&&Y<lower)\n  return ps2_rotate[1];\n'
	+'  if (X>=upper&&Y<lower)\n  return ps2_rotate[2];\n'
	+'  if (X>=upper&&Y>=lower&&Y<upper)\n  return ps2_rotate[3];\n'	
	+'  if (X>=upper&&Y>=upper)\n  return ps2_rotate[4];\n'
	+'  if (X>=lower&&X<upper&&Y>upper)\n  return ps2_rotate[5];\n'
	+'  if (X<lower&&Y>upper)\n  return ps2_rotate[6];\n'
	+'  if (X<lower&&Y>=lower&&Y<upper)\n  return ps2_rotate[7];\n'
	+'  return "x";\n'	
	+'}\n'
