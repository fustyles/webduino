...
Blockly.Blocks["test"] = {
	init:  function() {
		...
		this.appendDummyInput()
			.appendField(new Blockly.FieldImage(iconFlydown1, 18, 18, { alt: "*", flipRtl: "FALSE" }), fieldImageName1);
		this.field[fieldImageName1] = new myBlocksFlydownImage.eventparam(this.getField(fieldImageName), blocksXML1);
		
		
		const iconFlydown2 = "data:image/png;base64,";
		...
		this.appendDummyInput()
			.appendField(new Blockly.FieldImage(iconFlydown2, 18, 18, { alt: "*", flipRtl: "FALSE" }), fieldImageName2);
		this.field[fieldImageName2] = new myBlocksFlydownImage.eventparam(this.getField(fieldImageName), blocksXML2);	
