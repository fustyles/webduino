...
document.write('<div id="region" style="z-index:999"><video id="video" width="320" height="240" preload autoplay loop muted></video><canvas id="canvas"></canvas><canvas id="Image" style="display:none"></canvas><br>MirrorImage<select id="mirrorimage"><option value="1">yes</option><option value="0">no</option></select><br><br><div id="legendList"></div><br><div id="result" style="width:320px;color:red">Please wait for loading model.</div></div>');
...
window.onload = function () {
  ...
  async function DetectVideo() {
	...
	if (mirrorimage==1) {
	  context1.translate((canvas.width + video.width) / 2, 0);
	  context1.scale(-1, 1);
