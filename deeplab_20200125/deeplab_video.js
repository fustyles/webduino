...
document.write('<div id="region" style="z-index:999;position:absolute">Model<select id="model""><option value="pascal">pascal</option><option value="cityscapes">cityscapes</option><option value="ade20k">ade20k</option></select>MirrorImage<select id="mirrorimage""><option value="1">Y</option><option value="0">N</option></select><br><div id="result" style="color:red;z-index:999"></div><video id="video" width="320" height="240" preload autoplay loop muted></video><canvas id="canvas"></canvas><canvas id="Image" style="display:none"></canvas><br><div id="legendList"></div></div>');
