var catHands ='<xml>'+
'    <category name="%{BKY_CATHANDS}" id="hands" colour="310">'+
'      <block type="hands_video">'+
'      </block>'+
'      <block type="hands_startvideo_media">'+
'        <value name="width_">'+
...
'        </value>'+
'      </block>'+
'      <block type="hands_startvideo_stream">'+
'        <value name="src_">'+
'          <block type="text">'+
'            <field name="TEXT">http://192.168.x.x:81/stream</field>'+
'          </block>'+
'        </value>'+
'      </block>'+
'      <block type="hands_recognitied">'+
'      </block>'+
'      <block type="hands_state">'+
'      </block>'+
