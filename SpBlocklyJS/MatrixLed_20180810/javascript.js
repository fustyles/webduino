Blockly.JavaScript['matrix_led_initial'] = function(block) {
  ...
  var value_left_ = Blockly.JavaScript.valueToCode(block, 'value_left_', Blockly.JavaScript.ORDER_ATOMIC);
  var value_top_ = Blockly.JavaScript.valueToCode(block, 'value_top_', Blockly.JavaScript.ORDER_ATOMIC);	
  var value_color_ = Blockly.JavaScript.valueToCode(block, 'value_color_', Blockly.JavaScript.ORDER_ATOMIC);
  
  var code = 'MatrixLed_initial('+ value_width_ +', '+ value_height_ +', '+ value_left_ +', '+ value_top_ +', '+ value_color_ +');\n';
  return code;
};
...
Blockly.JavaScript['matrix_led_marquee_once'] = function(block) {
  ...
  var code = 'MatrixLed_marquee_times('+ value_marquee_ +','+value_times_+');\n';
  return code;
};
