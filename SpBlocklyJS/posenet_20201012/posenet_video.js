...
window.onload = function () {
	...
	modelnameTimer = setInterval(
	function(){
		var modelname = document.getElementById("modelname_posenet");
		if (modelname.innerHTML!="") {
			clearInterval(modelnameTimer);
	...
	function loadModel(modelname) {
		...
		posenet.load(ModelConfig).then(function(net) {
			...
			function(){
				var source = document.getElementById("sourceId_posenet");
				if (source.innerHTML!="") {
