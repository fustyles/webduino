...
module$exports$Blockly$JavaScript.javascriptGenerator.procedures_defreturn=function(a){
	...
	let f=module$exports$Blockly$JavaScript.javascriptGenerator.valueToCode(a,"RETURN",module$exports$Blockly$JavaScript.javascriptGenerator.ORDER_NONE)||"",g="";e&&f&&(g=c);
	f&&(f=module$exports$Blockly$JavaScript.javascriptGenerator.INDENT+"return "+f+";\n");
	const h=[],k=a.getVars();
	for(let l=0;l<k.length;l++)
		h[l]=module$exports$Blockly$JavaScript.javascriptGenerator.nameDB_.getName(k[l],$.NameType$$module$build$src$core$names.VARIABLE);
	m=(a.getFieldValue('async')!="")?a.getFieldValue('async')+" ":"";
	c=m+"function "+b+"("+h.join(", ")+") {\n"+c+d+e+g+f+"}";
	c=module$exports$Blockly$JavaScript.javascriptGenerator.scrub_(a,c);module$exports$Blockly$JavaScript.javascriptGenerator.definitions_["%"+b]=c;return null
};
...
module$exports$Blockly$JavaScript.javascriptGenerator.variables_set=function(a){
	...
	if (p=="GLOBAL")
		...
		return "var " + module$exports$Blockly$JavaScript.javascriptGenerator.nameDB_.getName(a.getFieldValue("VAR"),$.NameType$$module$build$src$core$names.VARIABLE)+" = "+b+";\n"
};
module$exports$Blockly$JavaScript.javascriptGenerator.variables_set_local=function(a){
	const b=module$exports$Blockly$JavaScript.javascriptGenerator.valueToCode(a,"VALUE",module$exports$Blockly$JavaScript.javascriptGenerator.ORDER_ASSIGNMENT)||"0";
	return module$exports$Blockly$JavaScript.javascriptGenerator.nameDB_.getName(a.getFieldValue("VAR"),$.NameType$$module$build$src$core$names.VARIABLE)+" = "+b+";\n"
};
