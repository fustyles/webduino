...
document.addEventListener('DOMContentLoaded', function() {
	...
	function runCode() {
	  ...
	  iframe_code += "\<\/head\>\<body\>\<div onclick='parent.document.exitFullscreen();' style='position:absolute;opacity:0.2;left:calc(100vw - 20px)'\>X\</div>\<script\>const delay=(seconds)=>{return new Promise((resolve)=>{setTimeout(resolve,seconds*1000);});};const main=async()=>{"+code+"};main();\<\/script\>\<\/body\>\<\/html\>";
