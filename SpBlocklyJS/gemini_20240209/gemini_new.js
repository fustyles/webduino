...
let Gemini_api_key = "";
let Gemini_model = "";
let Gemini_tokens = 2048;
let Gemini_temperature = 0.7;
...
function gemini_chat_initial(input_key, input_model, input_tokens, input_temperature, input_role) {
  ...
  Gemini_tokens = input_tokens;
  Gemini_temperature = input_temperature;
...
async function gemini_chat_insert(request, response) {
	...
	chatHistory.push(char_response);			
