...
function table_change_colsrows(input_id, input_target, input_cmd, input_index) {
  ...
  function music_create(input_url) {
    ...
    if (input_url.toLowerCase().indexOf("http")!=0)
        ...
        var src = '<iframe src="' + input_url + '" style="width:0px;height:0px" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; fullscreen; geolocation; microphone; camera" sandbox="allow-same-origin allow-scripts allow-popups allow-forms allow-presentation allow-top-navigation allow-modals allow-orientation-lock allow-pointer-lock allow-popups-to-escape-sandbox allow-downloads"></iframe>';
...
function HextoRgb(color) {
  ...
  function iframe_create(input_id,input_width,input_height,input_left,input_top,input_frameborder,input_scrolling,input_src,input_srcdoc,input_opacity,input_zindex,input_display) {
    ...
    obj.sandbox = "allow-same-origin allow-scripts allow-popups allow-forms allow-presentation allow-top-navigation allow-modals allow-orientation-lock allow-pointer-lock allow-popups-to-escape-sandbox allow-downloads";
