...
+(function (window, document) {
  ...
  function openURL(input_id_,input_url_,input_width_,input_height_,input_left_,input_top_,input_zindex_) {
    ...
    if (input_url_.toLowerCase().indexOf("http")!=0)
        ...
        var src = '<iframe sandbox="allow-same-origin allow-scripts allow-popups allow-forms" src="' + input_url_ + '" style="width:' + input_width_ + 'px;height:' + input_height_ + 'px" frameborder="0" allow="autoplay; fullscreen; geolocation; microphone; camera"></iframe>';
