document.write('<div id="region_trackingcolor" style="z-index:998;"><img id="gameimage_trackingcolor" width=320" height="240" style="position:absolute;visibility:hidden;" crossorigin="anonymous"><canvas id="gamecanvas_trackingcolor"></canvas><canvas id="gamecanvas_custom"></canvas></div>');
