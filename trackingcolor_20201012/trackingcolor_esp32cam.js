document.write('<div id="region_trackingcolor" style="z-index:998;"><img id="gameimage_trackingcolor" style="position:absolute;visibility:hidden" width="320" height="240" crossorigin="anonymous"><canvas id="gamecanvas_trackingcolor" width="320" height="240"></canvas><canvas id="gamecanvas_custom"></canvas></div>');
