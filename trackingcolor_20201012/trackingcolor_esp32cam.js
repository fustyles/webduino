document.write('<div id="region_trackingcolor" style="z-index:998;"><img id="gameimage_trackingcolor" style="position:absolute;visibility:hidden;width:320px;height:240px" crossorigin="anonymous"><canvas id="gamecanvas_trackingcolor"></canvas><canvas id="gamecanvas_custom"></canvas></div>');
