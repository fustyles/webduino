document.write('<div id="region_trackingcolor" style="z-index:998;"><img id="gameimage_trackingcolor" style="position:absolute;" crossorigin="anonymous"><canvas id="gamecanvas_trackingcolor" width="320" height="240"></canvas><canvas id="gamecanvas_custom"></canvas></div>');
...
window.onload = function () {
	...
	ShowImage.onload = function (event) {
	  ...
	  setInterval(function(){start();},200);         
	}	
