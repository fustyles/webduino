...
+(function (window, document) {
  ...
  function createIframe(notify_token,notify_userid,ifttt_msg) {
    
    var input_url="https://script.google.com/macros/s/AKfycbwNu63z3ZFHo38wp9LBAwDGyG8tI46-5d-TpFLYFiOHDVOvmgN0/exec?USERID="+notify_userid+"&MESSAGE="+ifttt_msg+"&TOKEN="+notify_token;
